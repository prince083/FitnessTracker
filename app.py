...
st.markdown(
    """
    <style>
    /* Darker background for the whole app */
    .stApp {
        background-color: #3F4F44;  /* Darker shade */
        color: #DCD7C9;  /* Light text for readability */
    }
    
    /* Sidebar background */
    section[data-testid="stSidebar"] {
        background-color: #2C3930 !important;  /* Even darker for contrast */
    }

    /* Headers */
    h1, h2, h3, h4, h5, h6 {
        color: #DCD7C9 !important;  /* Light color for better visibility */
    }

    /* Text fields and widgets */
...
st.image("https://wallpapercave.com/wp/wp2483079.jpg", use_container_width=True)
st.write("Hi, here you will be able to observe your predicted calories burned in your body. Pass your parameters such as `Age`, `Gender`, `BMI`, etc., into this WebApp and then you will see the predicted value of kilocalories burned.")
